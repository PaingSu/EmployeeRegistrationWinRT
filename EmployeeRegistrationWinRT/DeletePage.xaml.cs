    ...
    public sealed partial class DeletePage : Page
    {
        ...
        private void btnSearch_Click(object sender, RoutedEventArgs e)
        {
            ...
            for (int i = 0; i < StoreData.EName.Length; i++)
            {
                ...
                {
                    txtResultDel.Text = StoreData.EName[i] + "," + StoreData.Nrc[i] + "," + StoreData.BDDay[i] + "," + StoreData.Gender[i] + "," + StoreData.Department[i] + "," + StoreData.Team[i] + "," + StoreData.Position[i] + "," + StoreData.Phone[i] + "," + StoreData.Address[i] + "," + StoreData.Salary[i];
        ...
        private void btnDelete_Click(object sender, RoutedEventArgs e)
        {
            for (int i = 0; i < StoreData.EName.Length; i++)
            {
                ...
                StoreData.BDDay[i] = " ";
                StoreData.Gender[i] = "";
                StoreData.Department[i] = "";
                StoreData.Team[i] = "";
                StoreData.Position[i] = "";
                StoreData.Phone[i] = " ";
                StoreData.Address[i] = "";
                StoreData.Salary[i] = "";
            }
